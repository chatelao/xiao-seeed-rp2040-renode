...
- [ ] Phase 8.3: BEMF-based Load Compensation Logic
    ...
    - [x] Phase 8.3.3: Extend `MotorModel` Renode peripheral with a `LoadTorque` property for simulation. [2026-05-10]
    - [x] Phase 8.3.4: Create Robot Framework tests for closed-loop speed stability under varying load. [2026-05-10]
